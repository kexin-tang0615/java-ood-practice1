...
/**
 * Class Movie contains information about a movie, extending from the AMedia class. This class is
 * used as a part of problem1.
 */
public class Movie extends AMedia {

  /**
   * Constructor that creates a new Movie object, based upon all of the provided input parameters.
   *
   ...
   */
  public Movie(String alias, String title, Integer releaseYear, List<Name> directors,
